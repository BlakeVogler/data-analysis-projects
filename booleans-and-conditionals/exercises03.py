...
# e) If fuel_level is below 1000 OR engine_temperature is above 3500 OR engine_indicator_light is red blinking print "ENGINE FAILURE IMMINENT!" 
 ...
 print("ENGINE FAILER IMMINENT!")

# f) Otherwise, print "Fuel and engine status pending..." 

else: print("Fuel and engine status pending...")
...
# 6) a) Create the variable command_override, and set it to be true or false. If command_override is false, then the shuttle should only
# launch if the fuel and engine check are OK. If command_override is true, then the shuttle will launch regardless of the fuel and engine status.
